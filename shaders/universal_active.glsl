...
#define FakeHdr 1 //remaps colors to make lights and darks more saturated and correct overall saturation falloff
...
#define BlackLightness .20 //classic additive brightness but applied only to darks
...
#define ExposureExpansionIgnoreLevel  0.001 //stop boosting if too dark
